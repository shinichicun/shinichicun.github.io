...
export const profileConfig: ProfileConfig = {
	...
	links: [
		{
			name: 'QQ',								// Visit https://icones.js.org/ for icon codes
			icon: 'fa6-brands:qq',      			// You will need to install the corresponding icon set if it's not already included
			url: 'https://qm.qq.com/q/pVfqR9JxZI',	// `pnpm add @iconify-json/<icon-set-name>`
		},
		{
			name: 'Steam',
